...
{
    public class GetCourseDetailStatsHandler
        : IRequestHandler<GetCourseDetailStatsQuery, CourseStatsResponse>
    {
        ...
        public GetCourseDetailStatsHandler(
        ...
        public async Task<CourseStatsResponse> Handle(
            GetCourseDetailStatsQuery request,
