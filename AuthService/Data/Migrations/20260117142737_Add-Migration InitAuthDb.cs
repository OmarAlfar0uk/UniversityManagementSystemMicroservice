...
{
    /// <inheritdoc />
    public partial class AddMigrationInitAuthDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParentCodes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ParentCodes_Users_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParentCodes_Code",
                table: "ParentCodes",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ParentCodes_StudentId",
                table: "ParentCodes",
                column: "StudentId");
